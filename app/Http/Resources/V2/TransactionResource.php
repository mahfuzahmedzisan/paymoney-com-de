...
class TransactionResource extends JsonResource
{
    ...
    {
        $transactionType = optional($this->transaction_type)->name;

        if ($transactionType == 'Request_Sent') {
            $transactionType = 'Request_From';
        }

        if ($transactionType == 'Request_Received') {
            $transactionType = 'Request_To';
        }
