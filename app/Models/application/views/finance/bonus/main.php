...
$(document).ready(function(){
    ...
    $('.filter input[type=button]').bind('click', function(){
        document.location.href = '/<?php echo eregi_replace('/filter/([0-9]+,[0-9]+,[0-9]+,[0-9]+,[0-9]+)', '', url::current()) ?>/filter/'+$('.filter').find('select[name=status]').val()+','+$('.filter').find('select[name=collection]').val()+','+$('.filter').find('select[name=day]').val()+','+$('.filter').find('select[name=month]').val()+','+$('.filter').find('select[name=year]').val();
    });
...
<form action="/finance/pincode/save_collection" method="post"> 
	...
	<div class="in-bg" tab="main">
		...
		<div class="button2"> 
			<input type="button" class="submit" value="Отправить" /> <input type="button" class="cancel" value="Отменить" />
                        ...
                        <div class="content">
                            <div class="main">
                                ...
                                <div class="desc">
                                    ...
                                    <p>В этом модуле вы сможете сгенерировать бонусы в любом количестве и с любым номиналом, <br />и просмотреть список использованных пользователями бонусов. </p>
                                </div>
                                <div class="pad">
                                    <div class="button">
                                ...
                                <div class="tabs">
                                    <ul>
                                        ...
                                        <li><a href="/finance/bonus/collection">Коллекции</a></li>
                                    </ul>
                                    <br class="clearfloat" />
                                </div>
                                <br class="clearfloat" />
                                <div class="bg">
                                    <div class="in-bg">
                                        <table border="0" cellpadding="0" cellspacing="0" class="t6">
                                            ...
                                            <?php foreach ($data->list_bonus as $row): ?>
                                                <tr class="items<?php if ($row === end($data->list_bonus)) echo ' last' ?>" <?php if ($row->status == 2) echo 'bgcolor="#f2f2f2"'; ?><?php if ($row->status == 1) echo 'bgcolor="#d6ead6"'; ?>>                                                    
