...
$(document).ready(function(){
    ...
    $('.pad a[name=edit]').bind('click', function(){        
        if ($(this).find('img').attr('disabled') == 'disabled') {           
            ...
            $.ajax({
                type: 'POST',
                url: '/manage/pages/edit/id/'+$('.t6 tr.items input[type=checkbox]:checked').val(),         
    ...
    $('.t6 tr.items a[href=#edit]').bind('click', function(){
        ...
        $.ajax({
            type: 'POST',
            url: '/manage/pages/edit/id/' + $(this).parents('tr').find('input[type=checkbox]').val(),
            success: function(result){
                $('.form').html(result);
                $('.form').fadeIn(500);
                $('.loading').fadeOut(50);
    ...
    $('.sort a').bind('click', function(){
        document.location.href = '/<?php echo eregi_replace('/sort/([a-z_]+,[a-z_]+)', '', url::current()) ?>/sort/'+$(this).attr('rel');
    });
});
/* ]]> */
</script>
                    ...
                    <div class="container">
                        <div class="content">
                            <div class="main">
								...
								<!-- BEGIN FORM -->                                
								<div class="desc">
								    <h2><?php echo Kohana::lang('pages.header') ?></h2>
								    <p><?php echo Kohana::lang('pages.description') ?> </p>
								</div>
								<div class="pad">
								    <div class="button">
								...
								<!-- END FORM -->
                                <h2><?php echo Kohana::lang('pages.list') ?></h2>
                                <div class="bg">
								    <div class="in-bg">
								        <table border="0" cellpadding="0" cellspacing="0" class="t6">
								        	<tr class="sort">
								                ...
								                <th>
                                                	...
                                                	{
                                                	?>
                                                		<a href="javascript:;" rel="down,title"><?php echo Kohana::lang('pages.title') ?>&nbsp;<img src="/media/images/up.gif" alt="#"></a>
                                                	<?php
                                                	}
                                                	elseif (strpos(url::current(),'/sort/down,title'))
                                                	{
                                                	?>
                                                		<a href="javascript:;" rel="up,title"><?php echo Kohana::lang('pages.title') ?>&nbsp;<img src="/media/images/down.gif" alt="#"></a>
                                                	<?php
                                                	}
                                                	else
                                                	{
                                                	?>
                                                		<a href="javascript:;" rel="up,title"><?php echo Kohana::lang('pages.title') ?></a>
                                                	<?php
                                                	}
                                                	?>
                                                </th>								                
								                <th>
								                	<?php if (strpos(url::current(),'/sort/up,body_en'))
                                                	{
                                                	?>
                                                		<a href="javascript:;" rel="down,body_en"><?php echo Kohana::lang('pages.body_en') ?>&nbsp;<img src="/media/images/up.gif" alt="#"></a>
                                                	<?php
                                                	}
                                                	elseif (strpos(url::current(),'/sort/down,body_en'))
                                                	{
                                                	?>
                                                		<a href="javascript:;" rel="up,body_en"><?php echo Kohana::lang('pages.body_en') ?>&nbsp;<img src="/media/images/down.gif" alt="#"></a>
                                                	<?php
                                                	}
                                                	else
                                                	{
                                                	?>
                                                		<a href="javascript:;" rel="up,body_en"><?php echo Kohana::lang('pages.body_en') ?></a>
                                                	<?php
                                                	}
                                                	?>
                                                </th>
                                                <th>
								                	<nobr><?php if (strpos(url::current(),'/sort/up,body_ru'))
                                                	{
                                                	?>
                                                		<a href="javascript:;" rel="down,body_ru"><?php echo Kohana::lang('pages.body_ru') ?>&nbsp;<img src="/media/images/up.gif" alt="#"></a>
                                                	<?php
                                                	}
                                                	elseif (strpos(url::current(),'/sort/down,body_ru'))
                                                	{
                                                	?>
                                                		<a href="javascript:;" rel="up,body_ru"><?php echo Kohana::lang('pages.body_ru') ?>&nbsp;<img src="/media/images/down.gif" alt="#"></a>
                                                	<?php
                                                	}
                                                	else
                                                	{
                                                	?>
                                                		<a href="javascript:;" rel="up,body_ru"><?php echo Kohana::lang('pages.body_ru') ?></a>
                                                	<?php
                                                	}
                                                	?></nobr>
                                                </th>
								            </tr>	
								            <?php foreach ($data->list_pages as $row): ?>
												<tr class="items<?php if ($row === end($data->list_pages)) echo ' last' ?>">
								                    ...
								                    <td>
								                    <?php
								                    	if (strlen($row->body_en) > 120)
								                    	{
								                    		echo substr($row->body_en, 0, strpos($row->body_en, ' ', 119)).'...';
								                    	}
								                    	else
								                    	{
								                    		echo $row->body_en;
								                    ...
								                    <td>
								                    <?php
								                    	if (strlen($row->body_ru) > 120)
								                    	{
								                    		echo substr($row->body_ru, 0, strpos($row->body_ru, ' ', 119)).'...';
								                    	}
								                    	else
								                    	{
								                    		echo $row->body_ru;
