 ...
 *
 * $Id: Kohana.php 4372 2013-05-28 17:00:34Z ixmatus $
 *
 * @package    Core
 * @author     Kohana Team
...
final class Kohana {
	...
	/**
	 * Get a fields source file.
	 *
	 * @param   string   file name
	 * @return  mixed
	 */
	public static function include_fields($filepath)
	{
		$source_file = self::find_file('fields', implode('/', explode('.', $filepath)));
