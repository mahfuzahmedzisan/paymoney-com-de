            ...
            <div class="row mt-5 flex-column-reverse flex-lg-row">
                <div class="col-lg-8">
                    ...
                    <div class="shadow bg-secondary p-35">
                        ...
                        <div class="row mt-4 text-white" id="coin-list">
                            ...
                            <div class="col-md-6 mt-4 coin-div" coin-iso="{{ $coin['iso'] }}">
                                <div class="d-flex select-div p-2 coin-main-div">
                                    <div class="pr-2">
                                        <img height="40" width="40" src="{{ $coin['icon'] }}" alt="{{ __('Coin Icon') }}">
                                    </div>
                ...
                <div class="col-lg-4">
                    <div class="shadow bg-secondary py-4 text-white">
            ...
            $( filteredCoins ).each(function( index, filteredCoin ) {
                coinListHTML += `
                    <div class="col-md-6 mt-4 coin-div" coin-iso="${filteredCoin.iso}">
                        <div class="d-flex select-div p-2 coin-main-div">
                            <div class="pr-2">
                                <img class="w-50p" style="width: 50px;" src="${filteredCoin.icon}" alt="${coinIcon}">
                            </div>
